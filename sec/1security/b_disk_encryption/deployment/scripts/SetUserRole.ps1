function Start-ImmersionPostDeployScript {
	...
	AssignUserRole -RoleDefinitionName 'Key Vault Contributor'
    AssignUserRole -RoleDefinitionName 'Virtual Machine Contributor'
	AssignUserRole -RoleDefinitionName 'Network Contributor'
}